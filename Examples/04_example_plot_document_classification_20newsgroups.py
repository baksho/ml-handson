...
<https://en.wikipedia.org/wiki/Bag-of-words_model>`. This example uses a
...
script: `sphx_glr_auto_examples_text_plot_document_clustering.py` <https://scikit-learn.org/stable/auto_examples/text/plot_document_clustering.html#sphx-glr-auto-examples-text-plot-document-clustering-py>.
...
# # noqa: E501 for a demo on how such tuning can be done.
